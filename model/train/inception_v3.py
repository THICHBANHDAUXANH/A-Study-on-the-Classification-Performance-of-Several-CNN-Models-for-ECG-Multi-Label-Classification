...
batch_size = int(os.getenv("TRAIN_BATCH_SIZE", "120"))
...
best_model_path = MODEL_DIR/"best_inception_v3_ecg_model.pth"
...
history_path = MODEL_DIR/"inception_v3_training_history.npy"
