...
class ECGResNet50(nn.Module):
    def __init__(self, num_classes):
        ...
        self.resnet = self.resnet = models.resnet50(weights=models.ResNet50_Weights.DEFAULT)
...
val_f1_scores = []
best_val_f1 = 0.0
best_model_path = MODEL_DIR/"best_resnet50_ecg_model.pth"
...
history_path = MODEL_DIR/"resnet50_training_history.npy"
